...
>
        <div className="container max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="font-heading text-3xl md:text-4xl break-words font-extrabold text-white leading-tight mb-4">
              {post.title}
            </h1>
            ...
            {blogPosts
              ...
              .map((p) => (
                ...
                >
                  ...
                  <div className="h-20 w-60 flex flex-col justify-center ">
