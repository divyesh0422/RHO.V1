      ...
      <div className="p-5">
        ...
        <div className="flex gap-2">
          ...
          <a
            ...
            className="flex-1 h-11 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold text-sm flex items-center justify-center gap-2 hover:opacity-90"
          >
